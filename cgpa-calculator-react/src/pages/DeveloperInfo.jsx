                            ...
                            <Reveal key={project.id} delay={i * 60} direction="scale">
                                <div className={`project-card glass-card ${project.badge === 'Featured' || project.badge === 'Live' ? 'project-card--highlight' : ''}`}>
                                    ...
                                    <div className="project-card__actions">
                                        <a href={project.github} target="_blank" rel="noopener noreferrer" className="project-btn project-btn--github">
            ...
            <footer className="dev-footer">
                <div className="dev-footer__inner">
                    ...
                    <div className="dev-footer__links">
                        <a href="https://github.com/nithin1112006" target="_blank" rel="noopener noreferrer" className="dev-footer__link" aria-label="GitHub">
