...
export const departments = [
    ...
    { code: 'mech', name: 'Mechanical Engineering', shortName: 'MECH', icon: 'gear' },
    { code: 'agri', name: 'Agricultural Engineering', shortName: 'AGRI', icon: 'plant' },
...
export const DepartmentIcon = ({ type }) => {
    const icons = {
        computer: (
